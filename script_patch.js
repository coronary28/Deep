/* PATCH V4: requested 9 follow-up changes only (updated for compatibility) */
(function(){
  'use strict';
  ...
  @media (orientation:portrait) and (max-width:1180px){#exams-hint-bar{display:block!important}}
  `;
